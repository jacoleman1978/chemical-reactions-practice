 ...
 * @param cationCharge The charge of the cation of literal type CationCharge
 * @param anionCharge The charge of the anion of literal type AnionCharge
 * @returns CompoundSubscripts object using literal types FirstSubscript and SecondSubscript
 */

export const findCompoundSubscripts = (cationCharge: CationCharge, anionCharge: AnionCharge): CompoundSubscripts => {
