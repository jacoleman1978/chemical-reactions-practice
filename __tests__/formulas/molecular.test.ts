...
describe("Test hints for formulas with molecular compounds.", () => {
    ...
    test("Hints for first subscript", () => {
        expect(getFormulaHints("C/2/O", carbonMonoxide, "molecular")).toBe("When no Greek prefix is present for the first element in a molecular compound, that indicates that there is only one of that element.");
        expect(getFormulaHints("C/2/O", carbonDioxide, "molecular")).toBe("When no Greek prefix is present for the first element in a molecular compound, that indicates that there is only one of that element.");
        ...
        expect(getFormulaHints("As/2/F/5/", arsenicHexafluoride, "molecular")).toBe("When no Greek prefix is present for the first element in a molecular compound, that indicates that there is only one of that element.");
